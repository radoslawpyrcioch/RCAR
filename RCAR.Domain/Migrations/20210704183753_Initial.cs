        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Phone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ServiceSince = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ServiceTo = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentRecords_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_ServiceId",
                table: "PaymentRecords",
                column: "ServiceId");
